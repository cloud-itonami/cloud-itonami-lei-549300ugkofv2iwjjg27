(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (TC Energy Corporation, LEI
  549300UGKOFV2IWJJG27, Canada (CA-AB) jurisdiction -- the first Canada
  company in this actor family) -- unlike `commitledger.store`'s
...
(def ^:private demo-full-text
  "Legal Notices\nThese Legal Notices govern your access to and use of the TC Energy Corporation website. By using this site you agree to these terms, which may be updated without notice.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.tcenergy.com/legal-notices/"
