...
- Related: [`com-junkawasaki/root` ADR-2607110300](https://github.com/com-junkawasaki/root/blob/main/90-docs/adr/2607110300-cloud-itonami-lei-corporate-tos-catalog.edn)
  ...
  is the first Canada-jurisdiction company in this actor family).

## Context

This repository archives the publicly published legal notices of TC
Energy Corporation, per ADR-2607110300 -- a read-only reference archive.
As part of a second 10-repo validation batch extending the
...
- **Company**: TC Energy Corporation, LEI 549300UGKOFV2IWJJG27 (Canada,
  CA-AB jurisdiction), website `https://www.tcenergy.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url
  `https://www.tcenergy.com/legal-notices/`, retrieved-at `2026-07-19`,
